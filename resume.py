...
def get_opt():
    ...
    ### base options ###
    parser.add_argument('--name', type=str, default='both-resume' )
    ...
    parser.add_argument('--test_model_path', type=str, default='logs\seg_inpaint_logs\exp1-0320-1143\checkpoint\model_116.pth', help='which model used to test')
    #####################
